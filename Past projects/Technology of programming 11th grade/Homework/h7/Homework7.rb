...
def number_given_min
        ...
        for i in 1..29
                ...
                printf("Nomer %d e predal nai-malko puti [%d] na: ",i,arr.sort[1])
                for z in 0..28
	...
	for i in 1..29
		...
		for j in 1..29
			...
			if	arr3[[j,i]].to_i == arr3[[maxs,i]].to_i
				...
				print "Nomer " ,arr4[s], " e predal nai-malko na ", maxr, "[",arr3[[j,i]].to_i," puti ]" , "\n"
				puts
				s = s + 1
		...
		for j in 1..29
			...
			if	arr3[[j,i]].to_i == arr3[[maxs,i]].to_i
				...
				print "Nomer " ,arr4[s], " e predal nai-mnogo na ", maxr, "[",arr3[[j,i]].to_i," puti ]" , "\n"
				puts
				s = s + 1
