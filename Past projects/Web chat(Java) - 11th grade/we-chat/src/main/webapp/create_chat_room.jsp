...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		...
		<div id="site-content" role="main">
			<div class="container">
			<form class='register-form pull-left' action="chatroomRegister.do" method="post">
				<h1>Create new room</h1>
				<br>
				
				<p>
					<label for="name">Name</label>
					<input type="text" name="name" placeholder="Your chatroom name">
				</p>
				<p>
					<label for="description">Description</label>
					<input type="text" name="description" placeholder="Your chatroom description">
				</p>
				<input  class="btn register green medium" type="submit" value="Create">
