...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		...
		<div id="site-content" role="main">
			<div class="container">
			<form class='register-form pull-left' action="registration.do" method="post">
				...
				<p>
					...
					<input name="uname" type="text" placeholder="Your username">
				</p>
				<p>
				...
				<p>
					...
					<input name="email" type="text" placeholder="Your username">
					${invalid_mail}
					
				</p>
				<input  class="btn register green medium" type="submit" value="Register">
